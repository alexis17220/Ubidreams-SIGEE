...
// Objet de configuration de la table des types d'intervenants
const TypeIntervenantTableData = {
    typeIntervenant: {
        pagination: {
        ...
        columns: {
            ...
            categorie: {
                title: I18n.t(`pages.type.table.categorie`), // Titre de la colonne obtenu à partir de la traduction I18n
                key: 'categorie', // Clé unique de la colonne, correspond à la propriété 'categorie' des données
                dataIndex: 'categorie', // Propriété des données à afficher dans cette colonne
                sorter: (a, b) =>
                    defaultTo(get(a, 'categorie'), '').localeCompare(
                        defaultTo(get(b, 'categorie'), '')
                    ), // Fonction de tri pour trier les catégories par ordre alphabétique
                sortDirections: ['ascend', 'descend'], // Directions de tri possibles pour cette colonne
            },
            temoinauteur: {
                title: I18n.t(`pages.type.table.author`), // Titre de la colonne obtenu à partir de la traduction I18n
            ...
            temoindate: {
                title: I18n.t(`pages.type.table.date`), // Titre de la colonne obtenu à partir de la traduction I18n
...
export {TypeIntervenantTableData};
