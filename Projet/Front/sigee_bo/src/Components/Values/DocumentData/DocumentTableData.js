...
const DocumentTableData = {
    document: {
        ...
        columns: {
            ...
            id_engin: {
                title: I18n.t(`pages.document.table.registration`), // Titre de la colonne obtenu à partir de la traduction
                key: 'id_engin',
                dataIndex: 'id_engin', // Propriété des données utilisée pour cette colonne
                render: (id_engin) => get(id_engin, 'immatriculation'), // Fonction de rendu pour afficher l'immatriculation du véhicule associé
                sorter: (a, b) =>
