...
// Définition de l'objet GammeTableData contenant les informations de la table de gammes
const GammeTableData = {
    gammes: {
        pagination: {
        ...
        columns: {
            ...
            name: {
                title: I18n.t(`pages.gamme.name`),  // Titre de la colonne traduit
...
export {GammeTableData};  // Exportation de l'objet GammeTableData pour être utilisé dans d'autres fichiers
