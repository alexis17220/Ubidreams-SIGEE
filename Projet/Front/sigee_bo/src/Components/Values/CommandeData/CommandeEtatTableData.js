...
// Définition de l'objet CommandeEtatTableData qui contient les configurations pour la table des états de commande
const CommandeEtatTableData = {
    commandesEtat: {
        ...
        columns: {
            // Colonne 'nom'
            nom: {
                title: I18n.t(`pages.etatCommande.name`), // Titre de la colonne traduit
            ...
            // Colonne 'couleur2'
            couleur2: {
                title: I18n.t(`pages.etatCommande.colors`), // Titre de la colonne traduit
                key: 'couleur2', // Clé unique de la colonne
                dataIndex: 'couleur2', // Nom de la propriété des données à afficher dans cette colonne
                // Fonction de tri pour la colonne (tri par la propriété 'couleur2' des objets)
                sorter: (a, b) =>
                    defaultTo(get(a, 'couleur2'), '').localeCompare(
                        defaultTo(get(b, 'couleur2'), '')
                    ),
                sortDirections: ['ascend', 'descend'], // Directions de tri possibles (ascendant, descendant)
            },
        },
...
// Export de l'objet CommandeEtatTableData pour être utilisé dans d'autres parties du code
export {CommandeEtatTableData};
